...
<div class="account-info add-Ad" style="margin-left:-150px;">
        ...
        <form id="adForm" action="" method=""  enctype="multipart/form-data" >
            ...
            <dl>
                ...
                <dt>外链地址</dt>
                <dd><input type="text" name="ad_link" class="tool-tips"/> </dd>
...
<script>
    $(function(){
		...
		$(".tool-tips").on("click",function(){
		      layer.tips(
			     "链接地址请参考m.tiandaoedu.com/tdhd/all-all-all-all              例:m.tiandaoedu.com/tdhd/all-all-gkk-all 公开课",
				  ".tool-tips",
				   {tips: [2, '#c00']}
				   );
